 ...
 * @desc Based on version 2.2. Modified for this project.
 */
 ...
 * @return {string}
 *
 * @example Calculate the (hex-encoded) MD5 hash of a given string value
 *           const hash = md5("value"); // "2063c1608d6e0baf80249c42e2be5804"
 * @example Calculate the raw MD5 hash of a given string value
 ...
 * @return {string}
 *
 * @example Calculate the (hex-encoded) HMAC-MD5 hash of a given string value and key
 *           const hash = hmac_md5("value", "key"); // "01433efd5f16327ea4b31144572c67f6"
 * @example Calculate the raw HMAC-MD5 hash of a given string value and key
